"""
Crie um programa que recebe o nome, a idade e a altura do usuário, e verifica se o usuário tem a idade e a altura mínima para entrar no brinquedo.
Caso não tenha, o programa deverá barra a entrada do usuário.
"""
