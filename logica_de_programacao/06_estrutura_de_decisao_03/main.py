'''
Programa que receba o nome e a média final de um aluno, e o programa retorna se o aluno foi aprovado, se ficou de recuperação, ou se foi reprovado, com base em sua média final.
'''
